...
class spiders(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        all_books = response.css('div.comprar span::attr(data-book-id)').getall()
        print(all_books)
        return
        

        # https://www.planetadelibros.com.ar/includes/ajax_canales_venda.php?soporte=249678&_=1710357460255
